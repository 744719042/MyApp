...
public class HorizontalBannerView extends FrameLayout {
    ...
    public HorizontalBannerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HorizontalBannerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawCircles(Canvas canvas) {
        ...
        int centerY = getMeasuredHeight() - UIUtils.dp2px(10);
        int radius = UIUtils.dp2px(5);
        int margin = UIUtils.dp2px(10);
        int half = count / 2;
        ...
        for (int i = 0; i < count; i++) {
            if (i == chosen) {
                ...
                paint.setStrokeWidth(UIUtils.dp2px(1));
                paint.setStyle(Paint.Style.STROKE);
            }
